...
public class PlaceService {
    ...
    public List<Place> findPlaces(double latitude, double longitude, String type) {
        ...
        try {
            ...
            for (int i = 0; i < array.length(); i++) {
                try {
                    Place place = Place.getDetails((JSONObject) array.get(i));
    ...
    private String makeUrl(double latitude, double longitude, String place) {
        ...
        if (place.equals("")) {
            ...
            urlString.append("&name=Mondadori|Feltrinelli");
            ...
            urlString.append("&name=Mondadori|Feltrinelli|Deagostini");
            urlString.append("&key="+API_KEY);
        }
